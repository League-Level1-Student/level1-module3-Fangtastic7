...
public class SimonSays extends KeyAdapter {
	...
	public void keyPressed(KeyEvent e) {
		...
		// 16. If the keyCode matches the imageIndex and "Simon says"
			if(this.imageIndex==e.getKeyCode() && simonSays==true) {
				points = points +1;
				tries = tries + 1;
		...
		// 19. If the keyCode doesn't match the imageIndex and "Simon didn't say..."
			else if(this.imageIndex!=e.getKeyCode() && simonSays==false) {
				points = points +1;
				tries = tries +1;
				speak("You are correct.");
			}
		...
		if(tries>9) {
			JOptionPane.showMessageDialog(null, "Game Over! Your Final Score: " + points);
